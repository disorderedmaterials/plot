...
LineRenderer3D::LineRenderer3D(Qt3DCore::QEntity *rootEntity) : DataRenderer3D(rootEntity)
{
...
void LineRenderer3D::create(const ColourDefinition &colour, const std::vector<double> &x, const AxisEntity *xAxis,
